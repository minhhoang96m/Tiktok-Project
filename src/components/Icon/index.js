...
const IconHome = ({ className, width, height }) => {
    return (
        <svg
            className={className}
            width="32"
...
const IconHomeActive = ({ className, width, height }) => {
    return (
        <svg
            className={className}
            width="32"
...
const IconUserGroup = ({ className, width, height }) => {
    return (
        <svg
            className={className}
            width="32"
...
const IconUserGroupActive = ({ className, width, height }) => {
    return (
        <svg
            className={className}
            width="32"
...
const IconLive = ({ className, width, height }) => {
    return (
        <svg
            className={className}
            width="32"
...
const IconLiveActive = ({ className, width, height }) => {
    return (
        <svg
            className={className}
            width="32"
